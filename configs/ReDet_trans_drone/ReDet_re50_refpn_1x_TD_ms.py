...
# dataset settings
dataset_type = 'TransDroneDataset'
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/merged_annotations_train.json',
    ...
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/merged_annotations_val.json',
        img_prefix=data_root + 'images/',
        img_scale=(960, 540),
        img_norm_cfg=img_norm_cfg,
        size_divisor=32,
...
log_level = 'INFO'
work_dir = data_root + 'work_dirs/ReDet_re50_refpn_1x_TD_ms_test'
load_from = None
resume_from = None
workflow = [('train', 1)]
