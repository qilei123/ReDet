...
def filt_detections(detections, class_names, scale=1, threshold=0.3,cat_ids = [6]):
    polygons = []
...
def single_video_process(model,cap1,cap2,frame_size=(540,960),dst_dir=None,realscale=0.1):
    ...
    frame_index = 1
    while success:
        result_frame,detections = model.inference_single_vis(frame,None,frame_size,frame_size,frame_size)
        #print(detections)
...
def videos_process(src_dir,dst_dir,model_name = "retinanet_obb_r50_fpn_2x_TD_3cat_scratch",suffix = "MOV"):
    print("start initial detector")
...
if __name__ == '__main__':
    ...
    videos_process("/data2/qilei_chen/DATA/trans_drone/videos/whole_rounds","/data2/qilei_chen/DATA/trans_drone/videos/mix_result","retinanet_obb_r50_fpn_2x_TD_3cat_mix")
    videos_process("/data2/qilei_chen/DATA/trans_drone/videos/rounds","/data2/qilei_chen/DATA/trans_drone/videos/mix_result","retinanet_obb_r50_fpn_2x_TD_3cat_mix")
    #show_pickle()
    #show_gts()
